...
const Constants = {
  ...
  TWO_PI: Math.PI * 2,
  BASE_LAYERNAME: 'ol-plot-vector-layer',// 矢量图层名，（唯一标识）
  BASE_HELP_CONTROL_POINT_ID: 'plot-helper-control-point-div', // 控制点要素的基类id
  BASE_HELP_HIDDEN: 'plot-helper-hidden-div', // 父类隐藏容器
  DEF_TEXT_STYEL: { // 默认文本框样式
    borderRadius: '2px',
    fontSize: '12px',
    outline: 0,
    overflow: 'hidden',
