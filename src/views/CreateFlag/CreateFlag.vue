<template>
  <div id="cesiumContainer">
    <div class="plotting-tool">
      <el-button size="mini" @click="startDraw(0)">曲线旗标</el-button>
      <el-button size="mini" @click="startDraw(1)">矩形旗标</el-button>
      <el-button size="mini" @click="startDraw(2)">正三角旗标</el-button>
      <el-button size="mini" @click="startDraw(3)">倒三角旗标</el-button>
      <el-button size="mini" @click="startDraw(4)">对三角旗标</el-button>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    initCamera() {
      viewer.camera.flyTo({
        destination: window.Cesium.Cartesian3.fromDegrees(110, 40, 10000.0), //相机飞入点
      });
    },
    getLocation() {
