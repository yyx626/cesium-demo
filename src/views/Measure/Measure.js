  ...
  */
  ...
  drawLineMeasureGraphics(options) {
    ...
    if (this._viewer && options) {
      ...
      _handlers.setInputAction(function (movement) {
        ...
        CreateRemindertip($this._toolTip, endPos, true);
      ...
      _handlers.setInputAction(function (movement) {
        // 提示
        CreateRemindertip($this._toolTip, movement.position, false);
        _handlers.destroy()
        _handlers = null
  ...
  drawTrianglesMeasureGraphics(options) {
    ...
    if (this._viewer && options) {
      ...
      // left
      _handler.setInputAction(function (movement) {
        CreateRemindertip("点击左键开始绘制，再次点击结束绘制", movement.position, false);
      ...
      _handler.setInputAction(function (movement) {
        let endPos = movement.endPosition;
        CreateRemindertip("点击左键开始绘制，再次点击结束绘制", endPos, true);
